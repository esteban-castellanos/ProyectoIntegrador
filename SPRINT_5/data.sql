...
INSERT INTO `healthy_journey`.`products` (`id`, `name`, `short_description`, `image`, `price`, `store_id`) VALUES ('1', 'Almendras', 'Almendras orgánicas peladas 100gr', 'almendras.png', '180', '1');
INSERT INTO `healthy_journey`.`products` (`id`, `name`, `short_description`, `image`, `price`, `store_id`) VALUES ('2', 'Leche de Almendras', 'Leche de Almendras 50cl', 'leche_almendras.png', '250', '2');
INSERT INTO `healthy_journey`.`products` (`id`, `name`, `short_description`, `long_description`, `image`, `price`, `store_id`) VALUES ('3', 'Chocolate', 'Chocolate 1kilo', 'Dr. Cacao: ¡No somos golosina, somos alimento! Vinimos a reconectarte con el verdadero sabor del cacao. Somos deliciosos, somos reales.', 'chocolate_drcacao.jpg', '50', '1');
INSERT INTO `healthy_journey`.`products` (`id`, `name`, `short_description`, `long_description`, `image`, `price`, `store_id`) VALUES ('4', 'Vino', 'Vino Orgánico Malbec Roble Cecchin', 'Vino certificado orgánico y apto para veganos. Bodega Cecchin toma los frutos en el momento preciso respetando su propio espacio y tiempo. El proceso de producción y elaboración natural acompaña al medio ambiente, sosteniendo la continuidad de “no químicos” hasta acercar el producto a las mesas.', 'vino_organico.jpg', '480', '1');
INSERT INTO `healthy_journey`.`products` (`id`, `name`, `short_description`, `image`, `price`, `store_id`) VALUES ('5', 'Pistachos', 'Pistachos con cáscara 500gr', 'pistachos.png', '70', '1');
INSERT INTO `healthy_journey`.`products` (`id`, `name`, `short_description`, `long_description`, `image`, `price`, `store_id`) VALUES ('6', 'Yogur', 'Yogur 160gr, varios gustos disponibles.', 'Yogur elaborado a base de leche de coco y sin azúcar. Sin tacc, sin lactosa y vegano', 'yogur.png', '130', '2');
INSERT INTO `healthy_journey`.`products` (`id`, `name`, `short_description`, `image`, `price`, `store_id`) VALUES ('7', 'Avena', 'Avena arrollada orgánica 500gr', 'avena_organica.png', '500', '1');
INSERT INTO `healthy_journey`.`products` (`id`, `name`, `short_description`, `image`, `price`, `store_id`) VALUES ('8', 'Coco', 'Coco en escamas 100gr', 'coco_escamas.jpg', '80', '1');
INSERT INTO `healthy_journey`.`products` (`id`, `name`, `short_description`, `image`, `price`, `store_id`) VALUES ('9', 'Aceite de coco', 'Aceite de coco Neutro “MK Orgánic” 660cc', 'aceite_coco.jpg', '560', '3');
INSERT INTO `healthy_journey`.`products` (`id`, `name`, `short_description`, `long_description`, `image`, `price`, `store_id`) VALUES ('10', 'Helado', '500gr, varios gustos disponibles', 'A base de leche de coco, endulzado con azúcar orgánica.', 'helado.png', '360', '2');
